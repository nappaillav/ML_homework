...
test = LayerNormShapes()
test.setUp()
test.test_forward_shape()


test = TestMultiHeadedAttentionShapes()
test.setUp()
test.test_get_attention_weights_shape()
test.test_split_heads_shape()
test.test_merge_heads_shape()
test.test_apply_attention_shape()
test.test_forward_shape()

test = TestMiniGPT1Shapes()
test.setUp()
test.test_forward_shape()
test.test_loss_shape()