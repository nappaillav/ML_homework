...
class SVM:
    ...
    def infer(self, x):
        ...
        return self.make_one_versus_all_labels(out, self.m)
    ...
    def compute_accuracy(self, y_inferred, y):
        ...
        """
        n = y.shape[0]
        return np.sum(np.argmax(y, axis=1) == np.argmax(y_inferred, axis=1))/np.float(n)
